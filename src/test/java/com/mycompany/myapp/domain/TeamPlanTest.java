...
class TeamPlanTest {
    ...
    void teamTest() throws Exception {
        ...
        assertThat(teamBack.getTeamPlan()).isEqualTo(teamPlan);

        teamPlan.team(null);
        assertThat(teamPlan.getTeam()).isNull();
        assertThat(teamBack.getTeamPlan()).isNull();
    }
    ...
    void shiftTest() throws Exception {
        ...
        assertThat(shiftBack.getTeamPlan()).isEqualTo(teamPlan);

        teamPlan.shift(null);
        assertThat(teamPlan.getShift()).isNull();
        assertThat(shiftBack.getTeamPlan()).isNull();
    }
}
