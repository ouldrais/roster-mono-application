...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './position-requirement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSITIONREQUIREMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSITIONREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSITIONREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSITIONREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSITIONREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSITIONREQUIREMENT actions', async () => {
      const expectedActions = [
        {
