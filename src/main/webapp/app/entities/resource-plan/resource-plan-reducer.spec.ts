...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCEPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESOURCEPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESOURCEPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESOURCEPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCEPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESOURCEPLAN actions', async () => {
      const expectedActions = [
        {
