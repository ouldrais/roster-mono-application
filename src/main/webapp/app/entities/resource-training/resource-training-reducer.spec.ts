...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './resource-training.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCETRAINING_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESOURCETRAINING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESOURCETRAINING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESOURCETRAINING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCETRAINING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESOURCETRAINING actions', async () => {
      const expectedActions = [
        {
