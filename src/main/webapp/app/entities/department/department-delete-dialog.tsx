...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterApplicationmonoApp.department.delete.question">
        <Translate contentKey="rosterApplicationmonoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
