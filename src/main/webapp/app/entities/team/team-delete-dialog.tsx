...
export const TeamDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterApplicationmonoApp.team.delete.question">
        <Translate contentKey="rosterApplicationmonoApp.team.delete.question" interpolate={{ id: teamEntity.id }}>
