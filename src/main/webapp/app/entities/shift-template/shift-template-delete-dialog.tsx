...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterApplicationmonoApp.shiftTemplate.delete.question">
        <Translate contentKey="rosterApplicationmonoApp.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
