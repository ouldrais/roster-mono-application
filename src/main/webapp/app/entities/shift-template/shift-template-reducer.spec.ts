...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIFTTEMPLATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIFTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIFTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIFTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIFTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIFTTEMPLATE actions', async () => {
      const expectedActions = [
        {
