...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterApplicationmonoApp.resource.delete.question">
        <Translate contentKey="rosterApplicationmonoApp.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
