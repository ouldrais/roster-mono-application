...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIFTDEMAND_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIFTDEMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIFTDEMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIFTDEMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIFTDEMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIFTDEMAND actions', async () => {
      const expectedActions = [
        {
