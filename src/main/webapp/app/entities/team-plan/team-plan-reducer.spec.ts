...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './team-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEAMPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEAMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEAMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEAMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEAMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEAMPLAN actions', async () => {
      const expectedActions = [
        {
