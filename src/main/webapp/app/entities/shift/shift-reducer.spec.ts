...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shift.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIFT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIFT actions', async () => {
      const expectedActions = [
        {
