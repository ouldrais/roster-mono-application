...
public class PositionResource {
     ...
     */
    @GetMapping("")
    public List<Position> getAllPositions(@RequestParam(name = "filter", required = false) String filter) {
        if ("department-is-null".equals(filter)) {
            log.debug("REST request to get all Positions where department is null");
